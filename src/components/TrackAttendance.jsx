                  ...
                  >
                    ...
                    <select
                      ...
                      >
                        ...
                        <option value="one">FOS</option>
                        <option value="two">
                        FOL
                        </option>
                        <option value="three">FOE</option>
                        <option value="recses">FOM</option>
                        <option value="intern">
                        FEH
                        </option>
                      </select>
                    ...
                    <select
                      ...
                      >
                        ...
                        <option value="one">GCS3102</option>
                        <option value="two">
                        GCS3201
                        </option>
                        <option value="three">GCS31202</option>
                        <option value="recses">GCS203</option>
                      </select>
                    </div>
                    <div className="flex space-x-2  items-center">
                      ...
                      >
                        ...
                        <option value="pending">Phyiscal</option>
                        <option value="progress">Online</option>
                      </select>
                    </div>
